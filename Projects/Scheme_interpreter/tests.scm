...
;;; ********************************
; BEGIN PROBLEM 0
; --------added at Problem3: test core functionality
+
; expect #[+]
(+)
; expect 0
; --------added at Problem5: test correct evaluation of expr
(+ (- 2 4) (* 5 0) (- (+ 2 3) 2))
; expect 1

; --------added at Problem6 do_define_form: test edge case
; come back to p6 for more edge cases
(define x 2 y 90)
; expect Error
(define y (+ y 1))
; expect Error
...
(eval(eval(cons 'cdr '( '((+ (*) (*) (+)) 1)))))
; expect Error: int is not callable: 1

(car (eval(cons 'cdr '( '((+ (*) (*) (+)) 1)))))
; expect 1

(car (cons(+ 1 (*) (*)) (cons (car (eval(cons 'cdr '( '((+ (*) (*) (+)) 1))))) nil)))
; expect 3


(begin (- 1)(car (eval(cons 'cdr '( '((- (+) (*) (*)) 2))))))
; expect 2


((lambda (x) (/ x x) (- 4 x) (* x 2)) 2)
; expect 4

(((lambda (g) (lambda (f) (- f 8 g))) 1) 9)
; expect 0

((lambda (g) (lambda (f) (- f 8 g))) 1)
; expect (lambda (f) (- f 8 g))
...
(eval(or (and (or 1 (/1 (+))) (define a False)) False))
; expect #f
...
(define a (mu (b c) (* (*) d  b c e)))
((((lambda (x) (lambda (e) (lambda (d)(a 1 2))))3)4)5)
; expect 40
...
; expect composition
(define a (composition 1 1))
; expect a
(define x 10)
(define y 11)
(let ((x (* (+ (a 1 2) ((composition 2 3) 3 4)) 4)) (y 5)) (let ((x 5) (y 6)) (+ x y)))
; expect 11
